...
import cjmod.cjmod;
import cjmod.util.CardStats;
import cjmod.util.TriFunction;
...
import static cjmod.util.GeneralUtils.removePrefix;
import static cjmod.util.TextureLoader.getCardTextureString;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected static String makeID(String name) { return cjmod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    cjmod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
