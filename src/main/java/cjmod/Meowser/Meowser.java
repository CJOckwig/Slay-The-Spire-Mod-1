...
import static cjmod.cjmod.characterPath;
import static cjmod.cjmod.makeID;

public class Meowser extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Meowser"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass MEOWSER;
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Meowser(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
